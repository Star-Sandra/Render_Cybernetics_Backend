...
from smartmama.services.risk_model_service import RISK_RECOMMENDATIONS
...
class VisitLogBase(BaseModel):
    ...
    blood_sugar: float = Field(..., ge=0, le=40, description="Random/fasting blood sugar in mmol/L")
    body_temp: float = Field(..., ge=30, le=45, description="Body temperature in °C")
...
class VisitLogResponse(VisitLogBase):
    ...
    def recommendation(self) -> str:
        return RISK_RECOMMENDATIONS.get(self.risk_level, "")
